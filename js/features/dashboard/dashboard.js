...
function renderClassInfo(cls) {
  ...
  el.innerHTML = `
    <div class="dash-section-header">
      <span class="dash-section-title">${Icons.clipboard(16)} 학급 요약</span>
    </div>
    <div class="dash-info-cards">
      ...
      <div class="dash-info-card">
        <div class="dash-info-icon dash-info-icon--thermo">
          ${Icons.thermometer(22)}
        </div>
        <div class="dash-info-value">${temp}°</div>
        <div class="dash-info-label">온도</div>
      </div>
    </div>
  `;
}
